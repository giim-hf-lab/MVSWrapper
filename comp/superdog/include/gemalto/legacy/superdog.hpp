#if defined(__INTELLISENSE__) or \
	defined(__UTILITIES_LEGACY_BUILD__) or \
	defined(__GEMALTO_LEGACY_BUILD__)
...
#include "../../../vendor_codes/superdog.vc"
...
{
	using error_type = typename std::underlying_type_t<dog_error_codes>;
