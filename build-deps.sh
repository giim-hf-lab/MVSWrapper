...
cmake --toolchain "${PWD}/toolchains/${1}.cmake" -G Ninja -B build/ort \
...
cmake --toolchain "${PWD}/toolchains/${1}.cmake" -G Ninja -B build/torch \
...
cmake --toolchain "${PWD}/toolchains/${1}.cmake" -G Ninja -B build/torchvision \
